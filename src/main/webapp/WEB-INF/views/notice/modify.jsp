...
<html>
	...
	<div class="col-lg-8" align="center">
		<h2><strong>수정하기</strong></h2>
		<form id="noticeform" method="post" action="${root}/nmodifyProcess.do">
		...
		<br>
			...
			<div class="form-group" align="left">
				...
				<input type="text" class="form-control" id="subject" name="subject" placeholder="" value="${notice.subject}">
			</div>
			<div class="form-group" align="left">
				<label for="">내용</label>
				<textarea class="form-control" rows="15" cols="1" id="content" name="content">${notice.content}</textarea>
			</div>
			<br>
			<div class="form-group" align="center">
				<button type="submit" class="btn btn-success">확인</button>&nbsp;&nbsp;
				<button type="button" class="btn btn-warning" onclick="location.href='${root}/nlist.do'">취소</button>
			</div>
		</form>
	</div>
</div>
